    ...
    <div class="page-content">
      <ul class="input-panel">
        <li class="item">
          ...
          <span class="add-btn" @click="showPickerFn">{{bankInfo.bankName}}</span>
        </li>
        <li class="input-item-list">
          <span class="note">银行卡号</span>
          <div class="input-bar">
            <input placeholder="请输入银行卡号" type="input" maxlength="20" class="input" v-model="bankInfo.bankNo"/>
          </div>
        </li>
        <li class="input-item-list">
          <span class="note">预留手机号</span>
          <div class="input-bar">
            <input placeholder="请输入预留手机号" type="input" maxlength="11" class="input" v-model="bankInfo.phoneNo"/>
          </div>
        </li>
      </ul>
